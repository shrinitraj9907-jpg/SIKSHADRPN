  ...
  Widget _buildStatCards() {
    return GridView.count(
      ...
      children: [
        ...
        _buildStatCard(
            'Pending Inspections', '18', Icons.pending_actions, Colors.orange),
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            value,
            style: TextStyle(
                fontSize: 28, fontWeight: FontWeight.bold, color: color[800]),
          ),
  ...
  Widget _buildActionGrid(BuildContext context) {
    return GridView.count(
      ...
      children: [
        ...
        _buildActionButton(
            'Log Inspection', Icons.edit_document, Colors.teal, () {}),
        _buildActionButton('Escalation Inbox', Icons.inbox, Colors.red, () {
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (_) => const EscalationDashboardScreen(
                      userLevel: AdministrativeLevel.intermediate)));
        }),
        _buildActionButton(
            'Teacher Directory', Icons.contact_page, Colors.indigo, () {}),
      ],
    );
  }
