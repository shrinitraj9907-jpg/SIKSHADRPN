...
class _TeacherCheckinScreenState extends State<TeacherCheckinScreen> {
  ...
  Future<void> _handleCheckin() async {
    ...
    try {
      ...
      // Using a mock Teacher UID for prototype
      await DatabaseService().logTeacherCheckin('mock_teacher_123', now);
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            tooltip: 'Logout',
            onPressed: () {
              // Since this might be pushed inside the dashboard, we use pushAndRemoveUntil 
              // or just pushReplacement depending on navigation history
